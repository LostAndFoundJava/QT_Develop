...
**
** Created: Sat Apr 8 18:49:57 2017
...
static const char qt_meta_stringdata_notice[] = {
    "notice\0"
};
...
const QMetaObjectExtraData notice::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject notice::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_notice,
      qt_meta_data_notice, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &notice::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_notice))
